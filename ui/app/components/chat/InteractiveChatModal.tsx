    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div
        className={[
          ...
          "border border-zinc-200 dark:border-zinc-700 transition-all",
          isFullscreen
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.map((m, i) => (
            <div key={i} className={`flex ${m.role === "user" ? "justify-end" : "justify-start"}`}>
              {/* Adaptive width on small screens; keeps narrower bubbles on larger screens */}
              <div className="w-full sm:max-w-[80%] space-y-1">
                ...
                >
                  {/* Cap text line-length for readability; allow code to overflow-x */}
